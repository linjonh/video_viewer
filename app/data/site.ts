export const sites = {
  sites: [
    ...
    // {"key":"飞速资源","name":"飞速资源(切)","type":1,"api":"https://www.feisuzy.com/api.php/provide/vod/","searchable":0,"quickSearch":0},
    ...
    //   playUrl: "json:https://api.leduotv.com/wp-api/getvodurl.php?vid=",
    //   searchable: 1,
    //   quickSearch: 1,
    // },
  ],
  ...
  parses: [
    ...
    // type1 聚合.并发.轮询
    {
      ...
      ext: { flag: ["youku", "优酷", "mgtv", "芒果", "qq", "腾讯", "qiyi", "爱奇艺", "qq", "奇艺"] },
    },
    ...
    { name: "renrenmi3", type: 1, url: "https://sz.dxzj88.com/jxrjrm/jiaomi.php?url=", ext: { flag: ["renrenmi"] } },
    {
      ...
      ext: { flag: ["ltnb", "rx", "qiyi", "爱奇艺", "qq", "奇艺", "sohu", "letv", "youku", "优酷", "mgtv", "芒果"] },
    },
    ...
    { name: "初心影视1", type: 1, url: "http://jhpc.manduhu.com/j1217.php?url=", ext: { flag: ["youku", "优酷", "qq", "腾讯", "mgtv", "芒果"] } },
    {
      ...
      ext: { flag: ["ziqie", "youku", "优酷", "qiyi", "爱奇艺", "奇艺", "mgtv", "芒果", "qq", "腾讯"] },
    },
    {
      name: "我爱电影网",
      type: 1,
      url: "https://jhpc.manduhu.com/j1217.php?url=",
      ext: { flag: ["qiyi", "爱奇艺", "奇艺", "mgtv", "芒果", "youku", "优酷", "pptv", "PPTV"] },
    },
    {
      name: "初心影视9",
      type: 1,
      url: "https://api.m3u8.tv:5678/home/api?type=ys&uid=1931000&key=gktuvyzABEORSYZ135&url=",
      ext: { flag: ["youku", "优酷", "qq", "腾讯", "mgtv", "芒果"] },
    },
    {
      name: "江湖解析",
      type: 1,
      url: "http://103.40.240.46/jh/?url=",
      ext: { flag: ["renrenmi", "qq", "腾讯", "youku", "优酷", "mgtv", "芒果", "xigua", "西瓜"] },
    },
    {
      name: "王牌",
      type: 1,
    ...
    },
    {
      ...
      ext: { flag: ["qq", "腾讯", "qiyi", "爱奇艺", "奇艺", "youku", "优酷", "mgtv", "芒果"] },
    },
    {
      name: "欢雨",
      type: 1,
      url: "http://www.youhuifuligou.com/json/?id=7&url=",
      ext: { flag: ["qq", "腾讯", "qiyi", "爱奇艺", "奇艺", "youku", "优酷", "letv", "乐视", "xigua", "西瓜"] },
    },
    { name: "hfyrw", type: 1, url: "https://json.hfyrw.com/mao.go?url=", ext: { flag: ["ltnb", "renrenmi"] } },
    {
      ...
      ext: { flag: ["ltnb", "renrenmi", "xfyun", "miaoparty", "miaoparty2", "miaoparty3", "longteng", "xueren"] },
    },
    { name: "五一解析", type: 1, url: "https://json.5lp.net/json.php?url=", ext: { flag: ["ltnb", "renrenmi", "rx", "rongxing"] } },
    {
      ...
      ext: { flag: ["renrenmi", "rx", "rongxing", "mgtv", "芒果", "bilibili", "哔哩哔哩", "哔哩"] },
    },
    ...
    { name: "喵派对资源3", type: 1, url: "https://vip.aiaine.com/api/?key=fOWaGgFU45zlIjvbHI&url=", ext: { flag: ["ltnb", "renrenmi"] } },
    {
      ...
      ext: { flag: ["renrenmi", "qq", "腾讯", "qiyi", "爱奇艺", "奇艺", "youku", "优酷", "mgtv", "芒果", "bilibili", "哔哩哔哩", "哔哩", "sohu"] },
    },
    ...
    { name: "miao", type: 0, url: "https://jx.58g8.com/1/?url=", ext: { flag: ["miaoparty"] } },
    {
      ...
      ext: { flag: ["youku", "优酷", "mgtv", "芒果", "qq", "腾讯", "qiyi", "爱奇艺", "qq", "奇艺", "sohu", "letv"] },
    },
    {
      name: "万能解析",
      type: 0,
      url: "https://vip.legendwhb.cn/m3u8.php?url=",
      ext: { flag: ["ltnb", "renrenmi", "qq", "腾讯", "qiyi", "爱奇艺", "奇艺", "youku", "优酷", "mgtv", "芒果", "bilibili", "哔哩哔哩", "哔哩"] },
    },
